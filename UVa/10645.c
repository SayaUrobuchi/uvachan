...
int dp[101][21][51][3], last[101][21][51][3], last2[101][21][51][3], cost[51], benefit[51];
char chk[101][21][51][3];

void backtracing(int i, int j, int k, int l)
{
	if(j > 1)
	{
		backtracing(i-cost[k-1], j-1, last[i][j][k][l], last2[i][j][k][l]);
		printf(" %d", k);
	}
	else
	{
